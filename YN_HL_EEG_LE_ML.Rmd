...
1) find SNRs that have >= 80%
2) of those SNRs find the first derivetive of Alpha, Late Theta, ILE and RLE
3) of those SNRs find the peak of Alpha and Late Theta
