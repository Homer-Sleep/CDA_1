...
EEG.db.train$Cat_Effort = as.numeric(ifelse(EEG.db.train$Mean.LE.SNR <= 12, '0',
                     ifelse(EEG.db.train$Mean.LE.SNR <= 18, '1', 
                     ifelse(EEG.db.train$Mean.LE.SNR < 24, '2','2'))))

EEG.db.test$Cat_Effort = as.numeric(ifelse(EEG.db.test$Mean.LE.SNR <= 12, '0',
...
modelxg = xgboost(data = EEG.dm.train,
                  ...
                  nrounds = 150) # max.depth = 2, nrounds = 254, min MSRE = 3.012
...
modelxg = xgboost(data = EEG.dm.train,
                  ...
                  booster = 'gbtree',
                  objective = "multi:softmax", # or multi:softprob
                  nrounds = 340) # max.depth = 2, nrounds = 254, min MSRE = 3.012
