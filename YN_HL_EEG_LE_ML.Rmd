...
modelxg = xgboost(data = EEG.dm.train,
                  ...
                  nthread = 3,
                  booster = 'gbtree',
                  nrounds = 254) # max.depth = 2, nrounds = 254, min MSRE = 3.012
...
EEG.db.train$Cat_Effort = as.factor(ifelse(EEG.db.train$Mean.LE.SNR <= 12, 'Minimal',
                     ifelse(EEG.db.train$Mean.LE.SNR <= 18, 'Normal', 
                     ifelse(EEG.db.train$Mean.LE.SNR < 24, 'Ab_Normal','Ab_Normal'))))

EEG.db.test$Cat_Effort = as.factor(ifelse(EEG.db.test$Mean.LE.SNR <= 12, 'Minimal',
                     ifelse(EEG.db.test$Mean.LE.SNR <= 18, 'Normal', 
                     ifelse(EEG.db.test$Mean.LE.SNR < 24, 'Ab_Normal','Ab_Normal'))))
...
modelxg = xgboost(data = EEG.dm.train,
                  ...
                  nrounds = 100) # max.depth = 2, nrounds = 254, min MSRE = 3.012
