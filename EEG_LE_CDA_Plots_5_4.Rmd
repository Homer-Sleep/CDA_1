...
SelfReport_plot=ggplot()+
  ...
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=RLE),
             shape=21, fill = "black",stat="summary", fun=mean, size = 4)+
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=RLE),
              stat="summary", fun=mean, group=10, linetype='solid', size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=RLE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+
  
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=RLE),
              stat="summary", fun=mean, group=10, linetype='solid',  size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=RLE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+ 
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=RLE),
             shape=21,fill = "white", stat="summary", fun=mean, size = 4)+
...
SelfReport_plot=ggplot()+
  ...
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=ILE),
             shape=21, fill = "black",stat="summary", fun=mean, size = 4)+
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=ILE),
              stat="summary", fun=mean, group=10, linetype='solid', size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Descending'), aes(x=SNR_plot, y=ILE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+
  
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=ILE),
              stat="summary", fun=mean, group=10, linetype='solid',  size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=ILE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+ 
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Paradigm == 'Randomized'), aes(x=SNR_plot, y=ILE),
             shape=21,fill = "white", stat="summary", fun=mean, size = 4)+
...
WIN_Group <- lme(WIN_Score ~ Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

WIN_Group_SNR.main <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) + Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

WIN_Group_SNR.int <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) * Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

WIN_Group_SNR_Theta.main <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) * Group + Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

WIN_Group_SNR_Theta.int <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) * Group * Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(WIN_Null, WIN_Group, WIN_Group_SNR.main,WIN_Group_SNR.int,WIN_Group_SNR_Theta.main,WIN_Group_SNR_Theta.int)

print(paste("Effect on WIN for", Epoch_Win[i]))
GLMM_Tables(T_Result, Table.model = T)
}

```

 No effect of Theta, no need for individual group analysis
...
WIN_Group_SNR_Alpha.main <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) * Group + Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

WIN_Group_SNR_Alpha.int <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE) * Group * Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(WIN_Null, WIN_Group, WIN_Group_SNR.main,WIN_Group_SNR.int,WIN_Group_SNR_Alpha.main,WIN_Group_SNR_Alpha.int)
...
### WIN regressed by group for Alpha
...
WIN_SNR <- lme(WIN_Score ~ poly(SNR, degree = 3, raw = TRUE), random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

WIN_SNR_Alpha.main <- lme(WIN_Score ~ Alpha+poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

WIN_SNR_Alpha.int <- lme(WIN_Score ~ Alpha*poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")



T_Result=anova(WIN_Null, WIN_SNR, WIN_SNR_Alpha.main,WIN_SNR_Alpha.int)

print(paste("Effect on WIN for", Epoch_Win[i], Group_i))
GLMM_Tables(T_Result, Table.model = T)
...
RLE_Group_SNR.main <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) + Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

RLE_Group_SNR.int <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) * Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

RLE_Group_SNR_Theta.main <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) * Group + Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

RLE_Group_SNR_Theta.int <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) * Group * Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(RLE_Null, RLE_Group, RLE_Group_SNR.main,RLE_Group_SNR.int,RLE_Group_SNR_Theta.main,RLE_Group_SNR_Theta.int)

print(paste("Effect on RLE for", Epoch_Win[i]))
GLMM_Tables(T_Result, Table.model = T)
}

```

### RLE regressed by group for Theta
...
RLE_SNR <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE), random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

RLE_SNR_Theta.main <- lme(RLE ~ Theta+poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

RLE_SNR_Theta.int <- lme(RLE ~ Theta*poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

T_Result=anova(RLE_Null, RLE_SNR, RLE_SNR_Theta.main,RLE_SNR_Theta.int)

print(paste("Effect on RLE for", Epoch_Win[i], Group_i))
GLMM_Tables(T_Result, Table.model = T)
...
RLE_Group_SNR_Alpha.main <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) * Group + Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

RLE_Group_SNR_Alpha.int <- lme(RLE ~ poly(SNR, degree = 3, raw = TRUE) * Group * Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(RLE_Null, RLE_Group, RLE_Group_SNR.main,RLE_Group_SNR.int,RLE_Group_SNR_Alpha.main,RLE_Group_SNR_Alpha.int)
...
RLE_SNR_Alpha.main <- lme(RLE ~ Alpha+poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

RLE_SNR_Alpha.int <- lme(RLE ~ Alpha*poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

T_Result=anova(RLE_Null, RLE_SNR, RLE_SNR_Alpha.main,RLE_SNR_Alpha.int)
...
ILE_Group_SNR.main <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) + Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

ILE_Group_SNR.int <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) * Group, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

ILE_Group_SNR_Theta.main <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) * Group + Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

ILE_Group_SNR_Theta.int <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) * Group * Theta, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(ILE_Null, ILE_Group, ILE_Group_SNR.main,ILE_Group_SNR.int,ILE_Group_SNR_Theta.main,ILE_Group_SNR_Theta.int)

print(paste("Effect on ILE for", Epoch_Win[i]))
GLMM_Tables(T_Result, Table.model = T)
}

```

### ILE regressed by group for Theta
...
ILE_SNR <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE), random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

ILE_SNR_Theta.main <- lme(ILE ~ Theta+poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

ILE_SNR_Theta.int <- lme(ILE ~ Theta*poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

T_Result=anova(ILE_Null, ILE_SNR, ILE_SNR_Theta.main,ILE_SNR_Theta.int)

print(paste("Effect on ILE for", Epoch_Win[i], Group_i))
GLMM_Tables(T_Result, Table.model = T)
...
ILE_Group_SNR_Alpha.main <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) * Group + Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")

ILE_Group_SNR_Alpha.int <- lme(ILE ~ poly(SNR, degree = 3, raw = TRUE) * Group * Alpha, random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes"), method="ML")



T_Result=anova(ILE_Null, ILE_Group, ILE_Group_SNR.main,ILE_Group_SNR.int,ILE_Group_SNR_Alpha.main,ILE_Group_SNR_Alpha.int)
...
ILE_SNR_Alpha.main <- lme(ILE ~ Alpha+poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

ILE_SNR_Alpha.int <- lme(ILE ~ Alpha*poly(SNR, degree = 3, raw = TRUE) , random=~1|Sub,
                 data=filter(Epoch_List[[i]], Response != "NoRes", Group == Group_i), method="ML")

T_Result=anova(ILE_Null, ILE_SNR, ILE_SNR_Alpha.main,ILE_SNR_Alpha.int)
