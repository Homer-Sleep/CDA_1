...
WIN_Score_Group_SNR_Run.main <- lme((WIN_Score) ~ SNR*Group+Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

WIN_Score_Group_SNR_Run.int <- lme((WIN_Score) ~ SNR*Group*Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")


T_Result=anova(WIN_Score_NoCon, WIN_Score_Group, WIN_Score_Group_SNR.main,WIN_Score_Group_SNR.int,
               WIN_Score_Group_SNR_Run.main,WIN_Score_Group_SNR_Run.int) 
...
ILE_Group_SNR_Run.main <- lme((ILE) ~ Group*SNR + I(SNR^2)*Group + I(SNR^3)*Group + Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

ILE_Group_SNR_Run.int <- lme((ILE) ~  Run*SNR*Group + Run*I(SNR^2)*Group + Run*I(SNR^3)*Group, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

T_Result=anova(ILE_NoCon, ILE_Group, ILE_Group_SNR.main,ILE_Group_SNR.int,ILE_Group_SNR_Run.main,ILE_Group_SNR_Run.int) 
...
print(paste("SNR effect on ILE for", Group_i, Epoch_Win[i]))
...
RLE_Group_SNR_Run.main <- lme((RLE) ~ Group*SNR + I(SNR^2)*Group + I(SNR^3)*Group + Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

RLE_Group_SNR_Run.int <- lme((RLE) ~  Run*SNR*Group + Run*I(SNR^2)*Group + Run*I(SNR^3)*Group, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

T_Result=anova(RLE_NoCon, RLE_Group, RLE_Group_SNR.main,RLE_Group_SNR.int,RLE_Group_SNR_Run.main,RLE_Group_SNR_Run.int) 
...
print(paste("SNR effect on RLE for", Group_i, Epoch_Win[i]))
 GLMM_Tables(T_Result, Table.model = T)
...
SelfReport_plot=ggplot()+
  ...
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=RLE),
             shape=21, fill = "black",stat="summary", fun=mean, size = 4)+
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=RLE),
              stat="summary", fun=mean, group=10, linetype='solid', size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=RLE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+
  
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=RLE),
              stat="summary", fun=mean, group=10, linetype='solid',  size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=RLE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+ 
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=RLE),
             shape=21,fill = "white", stat="summary", fun=mean, size = 4)+
...
SelfReport_plot=ggplot()+
  ...
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=ILE),
             shape=21, fill = "black",stat="summary", fun=mean, size = 4)+
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=ILE),
              stat="summary", fun=mean, group=10, linetype='solid', size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_1', 'WIN_2')), aes(x=SNR_plot, y=ILE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+
  
  geom_line (data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=ILE),
              stat="summary", fun=mean, group=10, linetype='solid',  size=1.3)+
  stat_summary(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=ILE),
                  geom = "errorbar",fun.data = mean_se, size=.7,width=.2)+ 
  geom_point(data=dplyr::filter(PC_df, Group == "ONH",Condition != "LISN", Run %in% c('WIN_R1', 'WIN_R2')), aes(x=SNR_plot, y=ILE),
             shape=21,fill = "white", stat="summary", fun=mean, size = 4)+
