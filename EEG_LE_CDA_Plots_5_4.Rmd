...
RLE_Group_SNR.main <- lme((RLE) ~ Group+SNR, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

RLE_Group_SNR.int <- lme((RLE) ~ Group*SNR, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

RLE_Group_SNR_Run.main <- lme((RLE) ~ Group*SNR+Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")

RLE_Group_SNR_Run.int <- lme((RLE) ~ SNR*Group*Run, random=~1|Sub,
                 data=dplyr::filter(PC_df, !Run %in% c("Baseline", "WIN_P")), method="ML")
