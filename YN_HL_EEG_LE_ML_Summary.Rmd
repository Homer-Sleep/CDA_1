...
```{r,  echo=FALSE, warning=FALSE, results='hide',dpi = 300, dev.args = list(png  = list(type = "cairo")), eval=FALSE}
PC_plot=ggplot()+
...
lasso_var = c('Education', 'L4000', 'R2000', 'R6000', 'ILE_8', 'ILE_0', 'RLE_24', 'RLE_4', 'WIN_Score_24', 'WIN_Score_20')
```
...
if (sum(wanted %in% c("Mean.LE.SNR" , "Education","L4000","R2000","R6000","ILE.d1","ILE_0","RLE_24","RLE_4", "WIN_Score_24", "WIN_Score_20")) == 11){
 ...
 warning('Variables in consistent with prevous runs, check alias_list and lasso results')
 }
...
EEG.model = randomForest(formula = Mean.LE.SNR ~ ., 
                         data = EEG.db[['train']][colnames(EEG.db[['train']]) %in% wanted], ntree = ntree.best, mtry = best.m, importance=TRUE)
